...
function MyOrders() {
  ...
  return (
    ...
    >
      ...
      <h2 style={{ borderBottom: "2px solid #e74c3c", paddingBottom: "10px" }}>
        📦 My Orders & Subscriptions
      </h2>

      {orders.length === 0 ? (

        <p>No active orders or subscriptions found.</p>
        ...
        <div className="row g-4 mt-4">
          ...
          {orders.map((order) => {
            ...
            const isSubscription =
              order.planType === "Weekly" || order.planType === "Monthly";
            ...
            return (
              ...
              <div key={order._id} className="col-12">
                ...
                <div
                  className="p-4 rounded-4 d-flex flex-column flex-md-row justify-content-between align-items-md-center position-relative hover-effect"
                  style={{
                ...
                >
                  ...
                  <div className="mb-3 mb-md-0 ms-md-2">
                    ...
                    <h3 className="m-0 text-dark d-flex align-items-center flex-wrap gap-2 brand-font">
                      ...
                      {isSubscription && (
                        <span
                          className="badge bg-warning text-dark px-3 py-1 rounded-pill"
                  ...
                  <div className="text-md-end text-start mt-2 mt-md-0">
                    ...
                    <h3 className="m-0 text-dark brand-font fw-bold">
                      ₹{order.price}
                    </h3>
