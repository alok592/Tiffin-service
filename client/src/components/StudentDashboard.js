  ...
  useEffect(() => {
    ...
    fetch('http://localhost:5000/api/orders')
      ...
      .then(data => {
          ...
          // Show the latest accepted order as active subscription
      ...
      <main style={{ padding: "40px" }}>
        <div className="row g-4">
          ...
          <div className="col-lg-8">
            {/* Nearby Messes (Realistic Swiggy/Zomato Style) */}
...
const miniCardStyle = { border: "1px solid #f3f4f6", padding: "12px", borderRadius: "18px" };
